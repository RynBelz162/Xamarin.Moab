...
SWIFT_OUTPUT_PATH="framework_output"
...
echo "Verify results"
lipo -info "$SWIFT_BUILD_PATH/Release-iphonesimulator/Nuke.framework/Nuke"
...
cp -Rf "$SWIFT_BUILD_PATH/Release-iphonesimulator/Nuke.framework" "$SWIFT_OUTPUT_PATH"
