...
namespace Xamarin.Nuke
{
	...
	interface ImagePipeline
	{
		...
		// -(void)setCacheStrategyWithCacheStrategy:(enum DataCachingStrategy)cacheStrategy cacheName:(NSString * _Nonnull)cacheName sizeLimit:(NSInteger)sizeLimit;
		[Export("setCacheStrategyWithCacheStrategy:cacheName:sizeLimit:")]
		void SetCacheStrategyWithCacheStrategy(DataCachingStrategy cacheStrategy, string cacheName, nint sizeLimit);
