...
{
    [Preserve]
    internal static class MoabHelper
    {
        ...
        public static void SetCachingStrategy(CacheConfiguration cacheConfiguration = null)
        {
            ...
            ImagePipeline.Shared.SetCacheStrategyWithCacheStrategy(cacheConfiguration.DataCachingStrategy, cacheConfiguration.CacheName, cacheConfiguration.CacheSizeMb);
        }
